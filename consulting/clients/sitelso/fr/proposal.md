...
**Objet : Proposition — 2 sessions IA pour ton équipe**
...
- Un **document de recommandations personnalisées** basé sur l'audit de votre équipe : les 3 changements prioritaires, dans quel ordre, et pourquoi
- Un **starter kit** : votre `CLAUDE.md` finalisé, une liste des prompts les plus utiles pour votre contexte, et un plan sur 30 jours pour ancrer les nouvelles habitudes
- Un **guide de setup** à faire avant la première session (≈10 minutes) pour que tout le monde soit prêt dès le départ
...
**600 € pour les deux sessions** (groupe de 5 personnes, livrables inclus).

---

Tu veux qu'on cale les dates ?
