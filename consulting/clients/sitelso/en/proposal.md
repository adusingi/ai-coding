...
**Subject: Proposal — 2 AI sessions for your team**
...
- A **personalized recommendations document** based on your team audit: the 3 priority changes, in order, and why
- A **starter kit**: your finalized `CLAUDE.md`, a list of the most useful prompts for your context, and a 30-day plan to lock in the new habits
- A **setup guide** to complete before the first session (≈10 minutes) so everyone is ready from day one
...
**€600 for both sessions** (group of 5, deliverables included).

---

Want to lock in the dates?
